  ...
  return (
    ...
    >
      ...
      <section>
        ...
        <p>
          <strong>Boom My Wallet</strong> respects your privacy and is committed to protecting it
          through this Privacy Policy. This policy explains how we collect, use, and safeguard your
          information when you visit our website at
          <a
            href="https://boommywallet.shimaodexibao.dpdns.org"
            style={{ color: '#3182ce', textDecoration: 'none', marginLeft: '4px' }}
          >
      ...
      <section>
        ...
        <p>
          We implement industry-standard technical measures to protect your data. However, please
          note that no method of electronic transmission is 100% secure. We retain your data only as
