...
export default function Login() {
  ...
  const googleOauthSignIn = () => {
    if (window.top) window.location.href = `/auth/google/login?${params}`;
  };
    ...
    <>
      <div className="min-h-screen bg-gray-100 font-sans p-4 sm:p-8 content-center">
        <div className="max-w-3xl mx-auto bg-white rounded-xl shadow-2xl p-6 sm:p-8">
          <h1 className="text-3xl sm:text-4xl font-bold text-gray-800 text-center mb-6">Login</h1>
          <div>
            <p>
              <strong>Boom My Wallet</strong> is a financial management application where YOU OWN
              YOUR DATA.
            </p>
          ...
          <div>
            <button className="login-btn" onClick={googleOauthSignIn}>
              Sign-In With Google
            </button>
          </div>
          <Footer />
